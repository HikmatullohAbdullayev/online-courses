...
function Intro() {
    return (
        <section className="header_top container 1440px mx-auto px-[20px] mt-[100px] bg-[#10525B] pt-[86px] pb-[43px] text-center rounded-[10px] mobil2:mt-[40px] mobile450:mt-[20px]">
