...
import admission_data from "../data/admission_data";
  ...
  return (
        ...
        }} {...settings}>
    {
        admission_data.map((item) => (
            <div key={item.id} className=" bg-white text-start max-w-[286px] rounded-xl h-auto mobile450:max-w-[200px] shadow-md m-1 ">
            <Link to="">
